...
const pregFlagKeys = ["WINGLEADER_PREG", "KASYRRA_PC_PREG", "IMP_PC_PREG", "ALRAUNE_PC_PREG", "HORNET_PC_PREG", "GWYN_PREG", "WYVERN_PREG", "OVILIXER_PC_PREG", "SHAR_OVILIXER_PREG", "LUPINE_PC_PREG", "BRINT_PC_PREG"];
