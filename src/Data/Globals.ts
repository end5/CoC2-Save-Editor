const globalKeys = {
    Race: ["Human", "Chimera", "Elf", "Catfolk", "Lupine", "Orc", "Minotaur", "Cowgirl", "Taeleer", "Sheepfolk", "Foxmorph", "Harpy", "Manticore", "Gnoll", "Salamander", "Goblin", "Tanuki", "Mothfolk"],
    ...
    ItemHead: ["WitchsHat", "DuelingHat", "WideBrimmedHat", "HelmOfHeroes"],
    ...
    BottomGarb: ["PlainUnderwear", "SilkPanties", "SilkThong", "Stockings"],
    Offhand: ["HoplonShield", "TowerShield", "WickerShield", "LynxTotem"],
    TFs: ["FoxBerry", "CatsTongueBerry", "RootOfMan", "PinkEgg", "BlueEgg", "PurpleEgg", "TanEgg", "GoldEgg", "BruteBeet", "IceShard", "MinoBloodwine", "BovumSherry", "BaadClover", "CarrotCumpcake", "ManticoreNip", "VirilityBooster", "CackleBerry", "Wolfsboon", "Cinderleaf", "Frostleaf", "Grottato", "RingPeach", "GlitterDust"],
    ...
    KeyItems: ["BlueGemstoneStud", "BerwynsPanties", "AlchemistKit", "BasketOfJavelins", "OrcDisguise", "SilverMirror", "RampartKey", "DentedPot", "TarnishedKettle", "RustyCauldron", "JarlMedallion"],
