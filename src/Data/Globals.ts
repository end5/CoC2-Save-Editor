const globalKeys = {
    ...
    Boon: ["VelunsBlessing", "FountainsBounty", "HoneyMead", "SpicedWine", "RyeBeer", "AppleCider", "MonasteryAle", "LoversDry", "PaleAle", "TotalPurity"],
