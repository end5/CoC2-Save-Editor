const globalKeys = {
    ...
    ItemHead: ["WitchsHat", "DuelingHat", "WideBrimmedHat"],
    ...
    Set: ["PassionSet", "LoinSet", "SummonerSet", "OutriderSet", "KnightSet"],
